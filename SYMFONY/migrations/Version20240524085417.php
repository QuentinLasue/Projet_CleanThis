 ...
 */
final class Version20240524085417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse DROP postcode');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adresse ADD postcode INT NOT NULL');
        $this->addSql('ALTER TABLE operation DROP name_photo');
        $this->addSql('ALTER TABLE type_operation DROP photo_op');
    }
}
